...
public class ProductController {
	...
	public String filterProducts(@MatrixVariable(pathVar = "price") Map<String, Integer> filterParams,
			@PathVariable String category, @RequestParam String brand, Model model) {
		model.addAttribute("products", productService.filterProducts(filterParams, category, brand));
		return "products";
	}
	...
	public void initialiseBinder(WebDataBinder binder) {
		binder.setAllowedFields("productId", "name", "unitPrice", "description", "manufacturer", "category",
				"unitsInStock", "condition", "discontinued", "productImage", "language");
